      ...
      <div class="row" id="mBoard">
         ...
         <div class="col-md-4" style="width: 40%">
            ...
            <div class="mTitle">
               ...
               <span>공지사항</span> <a href="http://localhost:8080/NLibrary/BoardNoticeList.nds"><img
            ...
            <table class="table">
               ...
               <tbody>
                  <c:forEach items="${noticeBoardList}" var="item">
                     <tr href="BoardDetail.nds?board_id=${item.board_id}&type=notice" style="cursor:pointer;">
                        <td>${item.title}</td>
         ...
         <div class="col-md-4" style="width: 40%">
            ...
            <div class="mTitle">
               <span>스터디모집</span> <a href="http://localhost:8080/NLibrary/BoardStudyList.nds"><img
                  src="http://www.nsgportal.net/style/_skin/nongshim/portlet/red/img/more.gif"
                  alt="" /></a>
            </div>
            <hr class="title-line" />
            <table class="table">
               ...
               <tbody>
                  <c:forEach items="${studyBoardList}" var="item">
                     <tr href="BoardDetail.nds?board_id=${item.board_id}&type=study" style="cursor:pointer;">
                        <td>${item.title}</td>
                        <td>${item.modified_date}</td>
                     </tr>
                  </c:forEach>
         ...
         <div class="col-md-6">
            ...
            <ul class="list-inline new-book" style="">
               <c:forEach items="${newRegisteredBookList}" var="item">
                  <li style="width: 150px" "height: 205px"><img src="${item.image}" alt=""
                     style="width: 140px" />
                     <div>${item.title}</div>
                     <div>${item.author}</div>
                     <div>${item.publisher}</div>
